...
module alu #(
    ...
    localparam [4:0] SUB    = 5'b00100;  
    localparam [4:0] SLL    = 5'b00101;  
    localparam [4:0] SRL    = 5'b00110;  
    localparam [4:0] SLT    = 5'b00111; 
    localparam [4:0] SLTU   = 5'b01000;  
    ...
    localparam [4:0] BLTU   = 5'b01101;  
    localparam [4:0] BGE    = 5'b01110;  
    localparam [4:0] BGEU   = 5'b01111;  
    localparam [4:0] LUI    = 5'b10000;  
    localparam [4:0] AUIPC  = 5'b10001;  
    ...
    always @(*) begin
        case (i_alu_ctrl_EX)
            ...
            SRA: begin
                ...
                o_alu_result_EX = $signed(i_rd1_EX) >>> (i_rd2_EX[5-1:0]);
                o_equal_EX = 1'b0;  // todo: verify if this signal is not used on this 'case' @grouposiris
            end
