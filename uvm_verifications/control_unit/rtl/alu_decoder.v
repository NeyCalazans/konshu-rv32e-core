...
module alu_decoder (
    ...
    localparam logic [4:0] SUB    = 5'b00100;  // 4 check
    localparam logic [4:0] SLL    = 5'b00101;  
    localparam logic [4:0] SRL    = 5'b00110;  
    localparam logic [4:0] SLT    = 5'b00111;  // 7 check if it is signed comparison // it is (Zambotto)
    localparam logic [4:0] SLTU   = 5'b01000;  // 8 check unsigned
    ...
    localparam logic [4:0] BNE    = 5'b01011;  // 11 check
    localparam logic [4:0] BLT    = 5'b01100;  // 12 check
    localparam logic [4:0] BLTU   = 5'b01101;  // 13 check
    localparam logic [4:0] BGE    = 5'b01110;  // 14 check
    localparam logic [4:0] BGEU   = 5'b01111;  // 15 check
    localparam logic [4:0] LUI    = 5'b10000;  
    localparam logic [4:0] AUIPC  = 5'b10001;  // 17 check
