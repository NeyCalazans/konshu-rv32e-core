 ...
 *
 * @details Implements the standard UVM agent structure for the control-unit
 ...
 *          control-unit testbench and exposes the common sequence and analysis interfaces.
