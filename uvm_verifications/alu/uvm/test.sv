 ...
 *
 * @details Instantiates the verification environment and launches the ALU
 *          sequence that drives the DUT under test.
 * @ingroup uvm_components
 */
/**
 * @class test
 * @brief Top-level UVM test for the ALU verification bench.
 *
...
class test extends uvm_test;
    ...
    alu_sequence m_sequence;    ///< Main stimulus sequence, started on the agent's sequencer.
    ...
    virtual task run_phase(uvm_phase phase);
        ...
        m_sequence = alu_sequence::type_id::create("sequence");
