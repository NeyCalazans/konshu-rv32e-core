 ...
 *
 * @details Instantiates the verification environment and launches the hazard-unit
 *          sequence that drives the DUT under test.
 * @ingroup uvm_components
 */
/**
 * @class test
 * @brief Top-level UVM test for the hazard-unit verification bench.
 *
...
class test extends uvm_test;
    ...
    hazard_unit_sequence m_sequence;  ///< Main stimulus sequence, started on the agent's sequencer.
    ...
    virtual task run_phase(uvm_phase phase);
        ...
        m_sequence = hazard_unit_sequence::type_id::create("sequence");
